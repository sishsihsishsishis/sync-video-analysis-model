                ...
                for message in messages:
                    try:
                        ...
                        try:
                            ...
                            logging.error(f"Error extracting details for meeting ID {meeting_id}: {e}")
                        ...
                        try:
                            ...
                            logging.error(f"Error downloading resource from S3 for meeting ID {meeting_id}: {e}")
                        ...
                        try:
                            ...
                            logging.error(f"Error running rppg model for meeting ID {meeting_id}: {e}")
                        ...
                        try:
                            ...
                            logging.error(f"Error processing speaker data for meeting ID {meeting_id}: {e}")
                        ...
                        try:
                            ...
                            logging.error(f"Error processing heatmap for meeting ID {meeting_id}: {e}")
                        ...
                        try:
                            ...
                            logging.error(f"Error extracting audio for meeting ID {meeting_id}: {e}")
                        ...
                        try:
                            ...
                            logging.error(f"Error generating transcript for meeting ID {meeting_id}: {e}")
                        ...
                        try:
                            ...
                            logging.error(f"Error running diarization model for meeting ID {meeting_id}: {e}")
                        ...
                        try:
                            ...
                            logging.error(f"Error running emotion model for meeting ID {meeting_id}: {e}")
